...
const Register = () => {
  ...
  const handleInputChange = (e) => {
    ...
    setState((prevState) => ({
      ...
      isPassMatch:
        name === "confirmPass" ? value === state.pass : state.isPassMatch,
    }));
  };
      ...
      <div className="bg-white shadow-lg p-9 text-center relative w-[700px]">
        <div className="flex flex-col items-center">
          ...
          <p className="pt-5 text-base">
            <span className="block font-bold text-xl mb-1.25">
        ...
        <form>
          ...
          <div className="mt-8 relative">
            ...
            {state.isRoleEmpty && (
              <p className="text-red-500 absolute">Please select a role</p>
            )}
          </div>
          <div className="mt-8 flex relative">
            <label className="flex items-center mr-4">Gender:</label>
            ...
            {state.isGenderEmpty && (
              <p className="text-red-500 py-5 absolute">
